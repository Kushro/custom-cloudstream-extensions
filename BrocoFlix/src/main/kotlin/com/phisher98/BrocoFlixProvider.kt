...
@CloudstreamPlugin
class BrocoFlixPlugin : BasePlugin() {
    override fun load() {
        registerMainAPI(BrocoFlixProvider())
    }
}

// ─── Provider ────────────────────────────────────────────────────────────────

class BrocoFlixProvider : TmdbHydraBase() {
    override var mainUrl  = "https://brocoflix.xyz"
    override var name     = "BrocoFlix"
    override fun movieEmbedUrl(tmdbId: Int)                          = "https://vidsrc.net/embed/movie/$tmdbId"
    override fun tvEmbedUrl(tmdbId: Int, season: Int, episode: Int) = "https://vidsrc.net/embed/tv/$tmdbId/$season/$episode"
}

// ─── Shared TMDB base (inlined — no cross-module dependency needed) ───────────
